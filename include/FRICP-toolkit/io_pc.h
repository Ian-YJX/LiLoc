...
inline pcl::PointCloud<pcl::PointXYZRGB>::Ptr detect(const pcl::PointCloud<pcl::PointXYZINormal>::Ptr& local_, const pcl::PointCloud<pcl::PointXYZINormal>::Ptr& global_, const float& search_dis_){
    ...
    for(size_t i = 0; i < (size_t)global_num; i ++){
    ...
    for(size_t i = 0; i < (size_t)local_num; i++){
        std::vector<int> id;
    ...
    for(size_t i = 0; i < (size_t)select_num; i++){
